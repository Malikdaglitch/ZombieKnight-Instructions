...
class Game:
    ...
    def __init__(self, player, zombie_group, platform_group, portal_group, bullet_group, ruby_group):
        ...
        #Set sounds
        self.lost_ruby_sound = pygame.mixer.Sound("sounds/lost.wav")
        self.ruby_pickup_sound = pygame.mixer.Sound("sounds/pickup.wav")
    ...
    def draw(self):
        ...
        #Set text
        score_text = self.HUD_font.render(str(self.score), True, WHITE)
        ...
        while is_paused:
            for event in pygame.event.get():
                ...
                if event.type == pygame.QUIT:
                    is_paused = False
                    pygame.event.Event.post(pygame.event.Event(pygame.QUIT))
                    pygame.mixer.music.stop()
