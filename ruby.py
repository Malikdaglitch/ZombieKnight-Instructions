...
class Ruby(pygame.sprite.Sprite):
    ...
    def __init__(self, platform_group, portal_group):
        ...
        #Kinematic vectors
        self.postion = vector(self.rect.x, self.rect.y)
        ...
        self.acceleration = (0, self.VERTICAL_ACCELERATION)
    ...
    def check_collisions(self):
        ...
        collided_platforms = pygame.sprite.spritecollide(self, self.portal_group, False)


        if collided_platforms:
            self.postion.y = collided_platforms[0].rect.top + 1
            self.velocity.y = 0
