...
class Zombie(pygame.sprite.Sprite):
    ...
    def __init__(self, platform_group, portal_group, min_speed, max_speed):
        ...
        self.die_left_sprites = flip_frames(self.die_rights_sprites)


        #Rise is just death played in reverse — same frames, no need to reload
        self.rise_rights_sprites = list(reversed(self.walk_right_sprites))
        self.rise_lefts_sprites = list(reversed(self.walk_left_sprites))
        ...
        self.rect.rect.bottomleft = (random.randint(100, WINDOW_WIDTH - 100), -100)
        ...
        #Load sounds
        self.hit_sound = pygame.mixer.Sound("sound/zombie_sound.wav")
        self.kick_sound = pygame.mixer.Sound("sound/zombie_kick.wav")
        self.portal_sound = pygame.mixer.Sound("sound/portal_sound.wav")
    ...
    def check_collisions(self):
        ...
        collied_platforms = pygame.sprite.spritecollide(self, self.platform_group, False)


        if collied_platforms:
            self.postion.y = collied_platforms[0].rect.top + 1
            self.velocity.y = 0
    ...
    def check_animations(self):
        ...
        if self.animate_rise:
            if self.direction == 1:
                ...
                self.animate(self.rise_lefts_sprites, 0.095)
    ...
    def animate(self, sprite_list, speed):
        ...
        if self.current_sprite < len(sprite_list) -1:
            ...
            self.current_sprite = 0
        if self.animate_death:
            self.current_sprite = len(sprite_list),  len(sprite_list)-1
            self.animate_death = False
